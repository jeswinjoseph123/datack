...
import One from "@/public/images/service/pexels-lalorosas-907489.jpg";
import Two from "@/public/images/service/pexels-thisisengineering-3912478.jpg";
          ...
          <div className="row g-4">
            <div className="col-lg-8 order-2 order-lg-1">
              <div className="service-single__left-item">
                ...
                <p className="mb-20">
                  With the rise of mobile usage, having a well-built mobile app
                  is essential for expanding your digital presence. Our app
                  development services focus on creating robust, user-friendly
                  apps that deliver superior performance and functionality on
                  both Android and iOS platforms.
                </p>
                <p>
                  From ideation to deployment, we provide end-to-end app
                  development solutions. Whether you need a simple mobile app or
                  a more complex, feature-rich platform, our team works closely
                ...
                <div className="row g-5 mt-40 mb-40 align-items-center">
                  <div className="col-lg-5">
                    ...
                    <ul>
                      <li className="mb-15">
                        <i className="fa-solid fa-check"></i>Cross-Platform
                        Development
                      </li>
                      <li className="mb-15">
                        <i className="fa-solid fa-check"></i>User-Centric Design
                      </li>
                      <li className="mb-15">
                        <i className="fa-solid fa-check"></i>Scalability
                      </li>
                      <li className="mb-15">
                        <i className="fa-solid fa-check"></i>Push Notifications
                      </li>
                      <li className="mb-15">
                        <i className="fa-solid fa-check"></i>App Security
                      </li>
                    </ul>
                  </div>
                ...
                <p className="mb-30">
                  A mobile app is specifically designed for mobile devices and
                  typically requires download and installation from an app
                  store, while a web app is accessed through a browser and
                  doesn’t require installation. Mobile apps offer more
                  functionality and offline usage, while web apps are more
                  cost-effective and easier to update.
                </p>
