...
import Three from "@/public/images/faq/pexels-leeloothefirst-5428835.jpg";
              ...
              <div className="accordion" id="accordionExample">
                ...
                >
                  ...
                  >
                    <div className="accordion-body">
                      <p>
                        We cater to businesses across a wide range of
                        industries, including healthcare, education, finance,
                        retail, manufacturing, and technology. Our solutions are
                        customized to meet the specific needs and challenges
                        of each industry.
                      </p>
                    </div>
                  </div>
                ...
                >
                  <h2 className="accordion-header" id="headingTwo">
                    ...
                    >
                      How do you ensure the security of our data and IT systems?
                    </button>
                  </h2>
                  <div
                    id="collapseTwo"
                  ...
                  >
                    <div className="accordion-body">
                      <p>
                        ...
                        encryption, firewalls, multi-factor authentication, and
                        regular security audits. Our team follows industry best
                        practices to ensure your data remains protected and
                ...
                >
                  <h2 className="accordion-header" id="headingthree">
                    ...
                    >
                      Can you customize IT solutions to match our specific
                      business needs?
                    </button>
                  </h2>
                  <div
                  ...
                  >
                    <div className="accordion-body">
                      <p>
                        Yes! We tailor all our services, whether it’s app
                        development, web development, IT management, or
                        consultancy, to align with your business objectives. Our
                        team works closely with you to deliver
                ...
                >
                  <h2 className="accordion-header" id="headingFour">
                    ...
                    >
                      What kind of support do you offer after project
                      completion?
                    </button>
                  </h2>
                  <div
                  ...
                  >
                    <div className="accordion-body">
                      <p>
                        ...
                        including troubleshooting, updates, and performance
                        monitoring. Our 24/7 customer support ensures any issues
                        are resolved quickly, keeping your systems
                        running smoothly.
                      </p>
                    </div>
                  </div>
