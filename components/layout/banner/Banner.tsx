              ...
              <div className="container">
                <div className="banner__content">
                  ...
                  <p
                    ...
                    className="mt-20"
                  >
                   Discover innovative IT solutions designed to elevate your business and drive growth.
                  </p>
                  <Link
                    data-animation="slideInRight"
                    data-duration="2s"
              ...
              <div className="container">
                <div className="banner__content">
                  ...
                  <p
                    ...
                    className="mt-20"
                  >
                    Empowering businesses with tailored IT solutions that drive success
                  </p>
                  <Link
                    data-animation="slideInRight"
                    data-duration="2s"
              ...
              <div className="container">
                <div className="banner__content">
                  ...
                  <p
                    ...
                    className="mt-20"
                  >
                    Building intuitive and responsive websites that resonate with your audience
                  </p>
                  <Link
                    data-animation="slideInRight"
                    data-duration="2s"
